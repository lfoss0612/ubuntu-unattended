...
if [[ ! -f $tmp/$seed_file ]]; then
    ...
    download "https://raw.githubusercontent.com/lfoss0612/ubuntu-unattended/master/$seed_file"
fi
...
# set late command
   ...
   late_command="chroot /target curl -L -o /home/$username/start.sh https://raw.githubusercontent.com/lfoss0612/ubuntu-unattended/master/start.sh ;\
